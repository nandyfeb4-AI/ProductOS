...
export default function Sidebar({ activeView, onNavigate }) {
  ...
  const PROJECT_VIEWS = new Set(["project-detail", "workshop", "opportunity", "shaping", "artifacts", "stories", "jira", "feature-generator", "story-generator", "story-refiner", "story-slicer", "feature-refiner", "feature-prioritizer", "feature-hardening", "backlog-refinement", "competitor-analysis", "user-research"]);
